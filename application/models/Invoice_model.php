...
class Invoice_model extends CI_Model
{
    ...
    function get_all_invoice()
    {
        //$this->db->order_by('id', 'desc');
         $this->db->select('invoice.id, invoice.quotation_no, invoice.invoice_no,invoice.invoice_date,quotation.customer_name,(select sum(total) from item_service_list where item_service_list.quotation_no=invoice.quotation_no) as total,(select goods_service_desc from item_service_list where item_service_list.quotation_no=quotation.quotation_no and sl_no=1) as description')
         ->from('invoice')
     ...
     function get_quotation_from_date($params)
    {
        ...
        $this->db->select('quotation.id, quotation.quotation_no, quotation.quote_date,quotation.customer_name,quotation.mob_no,quotation.email,(select sum(total) from item_service_list where item_service_list.quotation_no=invoice.quotation_no) as total,(select goods_service_desc from item_service_list where item_service_list.quotation_no=quotation.quotation_no and sl_no=1) as description')
    ...
    function get_invoice_from_date($params)
    {
        ...
        // $this->db->where('quote_date <=', $params['to_date']);
        // return $this->db->get('quotation');
        $this->db->select('invoice.id, invoice.invoice_no, invoice.invoice_date,quotation.customer_name,quotation.mob_no,quotation.email,(select sum(total) from item_service_list where item_service_list.quotation_no=invoice.quotation_no) as total,(select goods_service_desc from item_service_list where item_service_list.quotation_no=quotation.quotation_no and sl_no=1) as description')
