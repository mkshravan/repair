        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo" style="background-color:#fff;">
                    ...
                    <span class="logo-mini"><img src="<?php echo site_url('resources/img/logo.png');?>" style="width:160px; height:50px" /></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><img src="<?php echo site_url('resources/img/logo.png');?>" style="width:160px; height:50px" /></span>
                </a>
