...
<img width="141" height="58" src="<?php echo site_url('resources/img/logo.png');?>" /></strong></p></td>
      <td width="33%" align="center" valign="top" style="padding:2px 0px;"> <p style="font-size:16px"><strong>Quotation</strong></p> </td>
...
<table cellspacing="0" cellpadding="1"  style="font-family:Arial, sans-serif; border-collapse:collapse; font-size:12px;" border="1" width="100%">
  ...
  <tr>
    <td style="padding:1px 3px;" colspan="2"><strong>Quotation Date</strong></td>
    <td style="padding:1px 3px;" colspan="4"><?php echo $quotation['quote_date'] ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="padding:1px 3px;" colspan="2" rowspan="2"><strong>Description</strong></td>
    <td style="padding:1px 3px;" colspan="4" rowspan="2"><?php echo $quotation['description'] ?></td>
  </tr>
  <tr>
...
<table cellspacing="1" cellpadding="1"  style="table-layout: fixed;width:100%;font-family:Arial, sans-serif; border-collapse:collapse; margin-top:15px; font-size:12px;" border="1">
  ...
  <tr>
    <td style="padding:1px 3px;" width="142"><strong>Sl No.</strong></td>
     <td style="padding:1px 3px;" width="71" colspan="2"><strong>HSN/SAC</strong></td>
  ...
  <tr>
     ...
     <td style="padding:1px 3px;" colspan="2">Amount Excluding Tax (INR)</td>
  ...
  <tr>
    ...
    <td style="padding:1px 3px;" colspan="2">Total GST (CGST+SGST) (INR)</td>
    <td align="right" style="padding:1px 3px;" id="gst_amount"><?php echo $i['cgst_value']+$i['sgst_value'];?></td>
  </tr>
  <tr>
    ...
    <td style="padding:1px 3px;" colspan="2">Amount (incl. of GST) (INR)</td>
    <td align="right" style="padding:1px 3px;" id="amount_incl_gst"><?php echo $i['cgst_value']+$i['sgst_value']+$quotation['quotation_amount'];?></td>
  </tr>
  <tr>
    ...
    <td style="padding:1px 3px;" colspan="2" rowspan="2" width="178"><strong>Amount Payable  (Rounded off) (INR)</strong></td>
    <td rowspan="2" align="right" style="padding:1px 3px;"><strong id="grand_amount"><?php echo round($i['cgst_value']+$i['sgst_value']+$quotation['quotation_amount']);?></strong></td>
  </tr>
  <tr>
  ...
  $(document).ready(function(){
    ...
    <?php $totalGst=0; 
      ...
      <?php 
       ...
       var total_inc_gst=totalGst+amount_before_gst;

       $("#amount_incl_gst").text(total_inc_gst.toFixed(2));
