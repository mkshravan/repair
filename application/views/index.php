          ...
          <ul class="header_btns_group ul_li">
            ...
            <li>
              <div class="header_hotline">
                ...
                <strong><a href="tel:+91-8709004521" class="text-white">+91-8709004521</a></strong>
              </div>
            </li>
          </ul>
        </nav>
    ...
    <main>
      ...
      <div class="sidebar-menu-wrapper">
        <!-- <div class="about_sidebar">
          ...
          <h3><span class="d-block">Downloads now,</span> the apps are available on the store</h3>
          <p>
            ...
            <div class="col col-lg-4 col-md-4 col-sm-6">
              <div class="footer_widget useful_links">
                ...
                <ul class="ul_li_block">
                  ...
                  <li><a href="laptop-repair-in-ranchi">Laptop Repair in Ranchi</a></li>
